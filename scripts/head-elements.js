$(document).ready(function() {
    ...
    $("head").append("<link rel='stylesheet' href='css/updated_accessible-content.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='css/updated_accessible-content-mq.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='css/updated_header.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='css/updated_header-media-queries.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='css/standard_faqs.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='css/standard_overlays.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='css/standard_hero.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='css/standard_socialmedia-footer.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='css/standard_footer.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='css/standard_sticky.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='css/standard_accessibility.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='css/standard_designs.css?v=1.1'>");
