$(document).ready(function() {
    ...
    $("head").append("<link rel='stylesheet' href='_css/normalize.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='_css/updated_global.css?=1.1'>");
    $("head").append("<link rel='stylesheet' href='_css/dynamic_global.css?v=1.1'>");
    ...
    $("head").append("<link rel='stylesheet' href='_css/standard_faqs.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='_css/standard_overlays.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='_css/standard_hero.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='_css/standard_socialmedia-footer.css?v=1.1'>");
    ...
    $("head").append("<link rel='stylesheet' href='_css/standard_accessibility.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='_css/standard_designs.css?v=1.1'>");
    $("head").append("<link rel='stylesheet' href='_css/standard_itservices.css?v=1.1'>");
